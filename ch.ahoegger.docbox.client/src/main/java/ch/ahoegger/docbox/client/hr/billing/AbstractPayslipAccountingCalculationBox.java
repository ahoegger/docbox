...
import ch.ahoegger.docbox.shared.hr.billing.AbstractPayslipAccountingBoxData;

/**
 * <h3>{@link AbstractPayslipAccountingCalculationBox}</h3>
 *
 * @author Andreas Hoegger
 */
@FormData(value = AbstractPayslipAccountingBoxData.class, defaultSubtypeSdkCommand = FormData.DefaultSubtypeSdkCommand.CREATE, sdkCommand = FormData.SdkCommand.CREATE)
public abstract class AbstractPayslipAccountingCalculationBox extends AbstractGroupBox {
  ...
  public class WorkingHoursField extends AbstractBigDecimalField {
    ...
    protected BigDecimal getConfiguredMinValue() {
      return IPayslipAccountingTable.WORKING_HOURS_MIN;
    }

    @Override
    protected BigDecimal getConfiguredMaxValue() {
      return IPayslipAccountingTable.WORKING_HOURS_MAX;
    }
  }
  ...
  public class BruttoWageField extends AbstractBigDecimalField {
    ...
    @Override
    protected BigDecimal getConfiguredMinValue() {
      return IPayslipAccountingTable.BRUTTO_WAGE_MIN;
    }

    @Override
    protected BigDecimal getConfiguredMaxValue() {
      return IPayslipAccountingTable.BRUTTO_WAGE_MAX;
    }
  }
  ...
  public class NettoWageField extends AbstractBigDecimalField {
    ...
    @Override
    protected BigDecimal getConfiguredMinValue() {
      return IPayslipAccountingTable.NETTO_WAGE_MIN;
    }

    @Override
    protected BigDecimal getConfiguredMaxValue() {
      return IPayslipAccountingTable.NETTO_WAGE_MAX;
    }
  }
  ...
  public class SocialSecurityTaxField extends AbstractBigDecimalField {
    ...
    @Override
    protected BigDecimal getConfiguredMinValue() {
      return IPayslipAccountingTable.SOCIAL_SECURITY_TAX_MIN;
    }

    @Override
    protected BigDecimal getConfiguredMaxValue() {
      return IPayslipAccountingTable.SOCIAL_SECURITY_TAX_MAX;
    }
  }
  ...
  public class SourceTaxField extends AbstractBigDecimalField {
    ...
    @Override
    protected BigDecimal getConfiguredMinValue() {
      return IPayslipAccountingTable.SOURCE_TAX_MIN;
    }

    @Override
    protected BigDecimal getConfiguredMaxValue() {
      return IPayslipAccountingTable.SOURCE_TAX_MAX;
    }
  }
  ...
  public class VacationExtraField extends AbstractBigDecimalField {
    ...
    @Override
    protected BigDecimal getConfiguredMinValue() {
      return IPayslipAccountingTable.VACATION_EXTRA_TAX_MIN;
    }

    @Override
    protected BigDecimal getConfiguredMaxValue() {
      return IPayslipAccountingTable.VACATION_EXTRA_TAX_MAX;
    }
  }
