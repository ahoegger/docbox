...
public abstract class AbstractPostingCalculationBox extends AbstractGroupBox {
  ...
  public class WorkingHoursField extends AbstractBigDecimalField {
    ...
    protected BigDecimal getConfiguredMinValue() {
      return IPostingGroupTable.WORKING_HOURS_MIN;
    }

    @Override
    protected BigDecimal getConfiguredMaxValue() {
      return IPostingGroupTable.WORKING_HOURS_MAX;
    }
  }
  ...
  public class BruttoWageField extends AbstractBigDecimalField {
    ...
    @Override
    protected BigDecimal getConfiguredMinValue() {
      return IPostingGroupTable.BRUTTO_WAGE_MIN;
    }

    @Override
    protected BigDecimal getConfiguredMaxValue() {
      return IPostingGroupTable.BRUTTO_WAGE_MAX;
    }
  }
  ...
  public class NettoWageField extends AbstractBigDecimalField {
    ...
    @Override
    protected BigDecimal getConfiguredMinValue() {
      return IPostingGroupTable.NETTO_WAGE_MIN;
    }

    @Override
    protected BigDecimal getConfiguredMaxValue() {
      return IPostingGroupTable.NETTO_WAGE_MAX;
    }
  }
  ...
  public class SocialSecurityTaxField extends AbstractBigDecimalField {
    ...
    @Override
    protected BigDecimal getConfiguredMinValue() {
      return IPostingGroupTable.SOCIAL_SECURITY_TAX_MIN;
    }

    @Override
    protected BigDecimal getConfiguredMaxValue() {
      return IPostingGroupTable.SOCIAL_SECURITY_TAX_MAX;
    }
  }
  ...
  public class SourceTaxField extends AbstractBigDecimalField {
    ...
    @Override
    protected BigDecimal getConfiguredMinValue() {
      return IPostingGroupTable.SOURCE_TAX_MIN;
    }

    @Override
    protected BigDecimal getConfiguredMaxValue() {
      return IPostingGroupTable.SOURCE_TAX_MAX;
    }
  }
  ...
  public class VacationExtraField extends AbstractBigDecimalField {
    ...
    @Override
    protected BigDecimal getConfiguredMinValue() {
      return IPostingGroupTable.VACATION_EXTRA_TAX_MIN;
    }

    @Override
    protected BigDecimal getConfiguredMaxValue() {
      return IPostingGroupTable.VACATION_EXTRA_TAX_MAX;
    }
  }
