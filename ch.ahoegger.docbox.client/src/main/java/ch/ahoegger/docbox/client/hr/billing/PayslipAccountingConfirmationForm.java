...
import ch.ahoegger.docbox.client.hr.billing.PayslipAccountingConfirmationForm.MainBox.CloseButton;

/**
 * <h3>{@link PayslipAccountingConfirmationForm}</h3>
 *
 * @author Andreas Hoegger
 */
public class PayslipAccountingConfirmationForm extends AbstractForm {
