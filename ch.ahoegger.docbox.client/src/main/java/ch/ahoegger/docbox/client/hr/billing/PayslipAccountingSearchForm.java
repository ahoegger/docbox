...
import ch.ahoegger.docbox.client.hr.billing.PayslipAccountingSearchForm.MainBox.SearchTabBox.SearchBox.EndDateBox;
import ch.ahoegger.docbox.client.hr.billing.PayslipAccountingSearchForm.MainBox.SearchTabBox.SearchBox.EndDateBox.EndDateFromField;
import ch.ahoegger.docbox.client.hr.billing.PayslipAccountingSearchForm.MainBox.SearchTabBox.SearchBox.EndDateBox.EndDateToField;
import ch.ahoegger.docbox.client.hr.billing.PayslipAccountingSearchForm.MainBox.SearchTabBox.SearchBox.PartnerField;
import ch.ahoegger.docbox.client.hr.billing.PayslipAccountingSearchForm.MainBox.SearchTabBox.SearchBox.StartDateBox;
import ch.ahoegger.docbox.client.hr.billing.PayslipAccountingSearchForm.MainBox.SearchTabBox.SearchBox.StartDateBox.StartDateFromField;
import ch.ahoegger.docbox.client.hr.billing.PayslipAccountingSearchForm.MainBox.SearchTabBox.SearchBox.StartDateBox.StartDateToField;
...
/**
 * <h3>{@link PayslipAccountingSearchForm}</h3>
 *
 * @author Andreas Hoegger
 */
@FormData(value = PayslipAccountingSearchFormData.class, sdkCommand = SdkCommand.CREATE)
public class PayslipAccountingSearchForm extends AbstractSearchForm {

  private BigDecimal m_taxGroupId;
  private Boolean m_includeUnbilled = Boolean.TRUE;

  public PayslipAccountingSearchForm() {
  ...
  public static class SearchHandler extends AbstractFormHandler {
    private PayslipAccountingSearchForm m_form;

    /**
     * @param form
     */
    public SearchHandler(PayslipAccountingSearchForm form) {
      m_form = form;
    }
