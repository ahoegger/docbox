 ...
 */
@PageData(PayslipTableData.class)
public class PayslipTablePage extends AbstractDocboxPageWithTable<PayslipTablePage.Table> {
  ...
  protected IPage<?> execCreateChildPage(ITableRow row) {
    ...
    page.setPayslipId(getTable().getIdColumn().getValue(row));
    return page;
  }
  ...
  public class Table extends AbstractTable {
    ...
    public class NewPayslipMenu extends AbstractMenu {
      ...
      protected void execAction() {
        ...
        BigDecimal payslipId = getIdColumn().getValue(getTable().getSelectedRow());
        PayslipForm form = new PayslipForm();
        form.getPartnerField().setValue(partnerId);
        form.setPayslipId(payslipId);
    ...
    @Order(50500)
    public class EditPayslipMenu extends AbstractMenu {
      @Override
      protected String getConfiguredText() {
    ...
    public class DeletePayslipMenu extends AbstractMenu {
      ...
      protected void execAction() {
        if (MessageBox.YES_OPTION == MessageBoxes.createYesNo()
          ...
          BEANS.get(IPayslipService.class).delete(getIdColumn().getSelectedValue());
