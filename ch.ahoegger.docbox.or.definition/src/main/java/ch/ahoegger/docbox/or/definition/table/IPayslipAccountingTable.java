...
/**
 * <h3>{@link IPayslipAccountingTable}</h3>
 *
 * @author Andreas Hoegger
 */
public interface IPayslipAccountingTable {

  public static String TABLE_NAME = "PAYSLIP_ACCOUNTING";

  // columns

  public static String PAYSLIP_ACCOUNTING_NR = "PAYSLIP_ACCOUNTING_NR";
