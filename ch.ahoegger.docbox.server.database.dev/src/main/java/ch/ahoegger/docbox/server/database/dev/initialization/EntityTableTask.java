...
public class EntityTableTask implements ITableTask, IEntityTable {
  ...
  public void createEntityRow(ISqlService sqlService, Long entityId, Long partnerId, BigDecimal postingGroupId, BigDecimal entityType, Date entityDate, BigDecimal hours, BigDecimal amount, String desc, Date billed) {
    StringBuilder statementBuilder = new StringBuilder();
