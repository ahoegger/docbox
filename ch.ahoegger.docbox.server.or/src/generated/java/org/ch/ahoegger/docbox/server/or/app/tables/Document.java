...
public class Document extends TableImpl<DocumentRecord> {
    ...
    private static final long serialVersionUID = -1383941573;
    ...
    public UniqueKey<DocumentRecord> getPrimaryKey() {
        return Keys.SQL190128171032232;
    }
    ...
    public List<UniqueKey<DocumentRecord>> getKeys() {
        return Arrays.<UniqueKey<DocumentRecord>>asList(Keys.SQL190128171032232);
    }
