...
public class TaxGroup extends TableImpl<TaxGroupRecord> {
    ...
    private static final long serialVersionUID = 1600700519;
    ...
    public UniqueKey<TaxGroupRecord> getPrimaryKey() {
        return Keys.SQL170823125047351;
    }
    ...
    public List<UniqueKey<TaxGroupRecord>> getKeys() {
        return Arrays.<UniqueKey<TaxGroupRecord>>asList(Keys.SQL170823125047351);
    }
