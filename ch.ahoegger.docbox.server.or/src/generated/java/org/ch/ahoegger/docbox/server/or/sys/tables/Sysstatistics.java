...
import org.ch.ahoegger.docbox.server.or.sys.tables.records.SysstatisticsRecord;
...
public class Sysstatistics extends TableImpl<SysstatisticsRecord> {
    ...
    private static final long serialVersionUID = -1655081362;
     ...
     */
    public final TableField<SysstatisticsRecord, String> STATID = createField("STATID", org.jooq.impl.SQLDataType.CHAR.length(36).nullable(false), this, "");

    /**
     * The column <code>SYS.SYSSTATISTICS.REFERENCEID</code>.
     */
    public final TableField<SysstatisticsRecord, String> REFERENCEID = createField("REFERENCEID", org.jooq.impl.SQLDataType.CHAR.length(36).nullable(false), this, "");

    /**
     * The column <code>SYS.SYSSTATISTICS.TABLEID</code>.
     */
    public final TableField<SysstatisticsRecord, String> TABLEID = createField("TABLEID", org.jooq.impl.SQLDataType.CHAR.length(36).nullable(false), this, "");
     ...
     */
    public final TableField<SysstatisticsRecord, String> TYPE = createField("TYPE", org.jooq.impl.SQLDataType.CHAR.length(1).nullable(false), this, "");
    ...
    /**
     * The column <code>SYS.SYSSTATISTICS.STATISTICS</code>.
     */
    ...
    private Sysstatistics(String alias, Table<SysstatisticsRecord> aliased) {
        this(alias, aliased, null);
    }

    private Sysstatistics(String alias, Table<SysstatisticsRecord> aliased, Field<?>[] parameters) {
