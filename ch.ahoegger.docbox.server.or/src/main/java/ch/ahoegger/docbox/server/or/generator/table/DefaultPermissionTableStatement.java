...
public class DefaultPermissionTableStatement implements ITableStatement, IDefaultPermissionTable {
  ...
  public void deleteTable(Connection connection) {
    ...
    DSL.using(connection, SQLDialect.DERBY).delete(DefaultPermissionTable.DEFAULT_PERMISSION_TABLE)
        .execute();
  ...
  public void dropTable(Connection connection) {
    ...
    DSL.using(connection, SQLDialect.DERBY).dropTable(DefaultPermissionTable.DEFAULT_PERMISSION_TABLE)
        .execute();
  }
