...
public class EntityTableStatement implements ITableStatement, IEntityTable {
  ...
  public String getCreateTable() {
    ...
    statementBuilder.append(PAYSLIP_NR).append(" BIGINT, ");
  ...
  public void deleteTable(Connection connection) {
    ...
    DSL.using(connection, SQLDialect.DERBY).delete(Entity.ENTITY)
        .execute();
  ...
  public void dropTable(Connection connection) {
    ...
    DSL.using(connection, SQLDialect.DERBY).dropTable(Entity.ENTITY)
        .execute();
  }
