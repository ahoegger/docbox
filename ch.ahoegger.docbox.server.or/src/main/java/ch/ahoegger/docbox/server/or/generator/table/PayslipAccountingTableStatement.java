...
/**
 * <h3>{@link PayslipAccountingTableStatement}</h3>
 *
 * @author Andreas Hoegger
 */
public class PayslipAccountingTableStatement implements ITableStatement, IPayslipAccountingTable {
  private static final Logger LOG = LoggerFactory.getLogger(PayslipAccountingTableStatement.class);

  @Override
  public String getCreateTable() {
    StringBuilder statementBuilder = new StringBuilder();
    statementBuilder.append("CREATE TABLE ").append(TABLE_NAME).append(" (");
    statementBuilder.append(PAYSLIP_ACCOUNTING_NR).append(" BIGINT NOT NULL, ");
    ...
    statementBuilder.append("PRIMARY KEY (").append(PAYSLIP_ACCOUNTING_NR).append(")");
  ...
  public void deleteTable(Connection connection) {
    ...
    DSL.using(connection, SQLDialect.DERBY).delete(PayslipAccounting.PAYSLIP_ACCOUNTING)
        .execute();
  ...
  public void dropTable(Connection connection) {
    ...
    DSL.using(connection, SQLDialect.DERBY).dropTable(PayslipAccounting.PAYSLIP_ACCOUNTING)
        .execute();
  }
