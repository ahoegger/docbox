...
import ch.ahoegger.docbox.server.database.initialization.DocumentCategoryTableTask;
import ch.ahoegger.docbox.server.database.initialization.DocumentPartnerTableTask;
