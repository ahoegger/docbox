...
/**
 * <h3>{@link PayslipAccountingServiceTest_PrepareCreate}</h3>
 *
 * @author Andreas Hoegger
 */
public class PayslipAccountingServiceTest_PrepareCreate extends AbstractTestWithDatabase {
  ...
  public void testPrepareCreate() {
    PayslipAccountingFormData data = new PayslipAccountingFormData();
    ...
    data = BEANS.get(PayslipAccountingService.class).prepareCreate(data);
