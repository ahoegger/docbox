...
/**
 * <h3>{@link PayslipServiceTest_FindUnbilld}</h3>
 *
 * @author Andreas Hoegger
 */
public class PayslipServiceTest_FindUnbilld extends AbstractTestWithDatabase {
  ...
  public void testSearchApril() {
    List<EntityTableRowData> unbilledEntities = BEANS.get(PayslipService.class).getUnbilledEntities(LocalDateUtility.toDate(LocalDate.of(2016, 4, 1)), LocalDateUtility.toDate(LocalDate.of(2016, 4, 30)), BigDecimal.valueOf(5));
