...
public class PaySlipServiceTest extends AbstractTestWithDatabase {
  ...
  public void setupDb() throws Exception {
    ...
    BEANS.get(PostingGroupTableTask.class).createRow(sqlService, postingGroupId01, partnerId01, documentId01, "August 2016", LocalDateUtility.today(), BigDecimal.valueOf(10.5), BigDecimal.valueOf(234.9), BigDecimal.valueOf(232.1),
